...
public class HourlyTempForecastAdapter extends ListAdapter<TemperatureProto, HourlyTempForecastAdapter.ViewHolder> {
	...
	public static class ViewHolder extends RecyclerView.ViewHolder {
		...
		public void bindTo(@NonNull TemperatureProto item) {
